...
public class King extends ChessPiece {
    ...
    public void move(String position) throws IllegalChessMoveException {
        ...
        if ((Math.abs(indeks1 - indeks3) == 1 || Math.abs(indeks1 - indeks3) == 0) && (Math.abs(indeks2 - indeks4) == 1 || Math.abs(indeks2 - indeks4) == 0) && !(Math.abs(indeks1 - indeks3) == 0 && Math.abs(indeks2 - indeks4) == 0))
            super.move(position);
